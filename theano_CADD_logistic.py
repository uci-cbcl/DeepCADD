...
class LogisticRegression(object):
    ...
    def __init__(self, input, n_in, n_out):
        ...
        #I hope changing T.dot to theano.dot keeps things cool
...
def load_data(dataset, scale=False):
    ...
    valid_X = training_X[28800000:]
    valid_y = training_y[28800000:]
    
    training_X = training_X[:28800000]
    training_y = training_y[:28800000]
    ...
    def shared_dataset(data_xy, borrow=True):
        ...
        shared_x = theano.sparse.shared(data_x, borrow=borrow)
    ...
    test_set = (testing_X, testing_y)
    valid_set = (valid_X, valid_y)
    train_set = (training_X, training_y)
...
def sgd_optimization_cadd(datasets, learning_rate=0.01, n_epochs=1000, batch_size=100000):
    """
    ...
    classifier = LogisticRegression(input=x, n_in=train_set_x.get_value(borrow=True).shape[1], n_out=2)
...
if __name__ == '__main__':
    ...
    sgd_optimization_cadd(datasets, n_epochs=e, batch_size=m)
