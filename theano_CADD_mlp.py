...
from theano_CADD_logistic import LogisticRegression, load_data
...
class HiddenLayer(object):
    def __init__(self, rng, input, n_in, n_out, W=None, b=None,
        ...
        lin_output = theano.dot(input, self.W) + self.b
...
def mlp_cadd(datasets, learning_rate=0.01, L1_reg=0.00, L2_reg=0.00001, n_epochs=1000,
             batch_size=100000, n_hidden=500):
    """
   ...
   """
    ...
    x = theano.sparse.csr_matrix('x')  # the data is a sparse matrix
...
if __name__ == '__main__':
    description = "Apply MLP to CADD training data"
    ...
    parser.add_argument("-m", "--minibatch", dest="minibatch", help="Mini-batch size. Default: 100000", type=int, default=100000)
    parser.add_argument("-hidden", "--hidden", dest="hidden", help="Number of hidden units. Default: 500", type=int, default=500)    
    parser.add_argument("-e", "--epoch", dest="epoch", help="Number of epochs to run. Default: 100", type=int, default=100)    
    ...
    mlp_cadd(datasets, n_epochs=e, batch_size=m, n_hidden=h)
